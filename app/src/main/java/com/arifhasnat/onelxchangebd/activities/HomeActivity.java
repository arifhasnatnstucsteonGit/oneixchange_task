...
public class HomeActivity extends AppCompatActivity
    ...
    private ArrayList<StudentDataModel> studentDataModelArrayList;
...
//                        .setAction("Action", null).show();
        ...
        studentLayoutmanager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            startActivity(new Intent(HomeActivity.this,ImportsActivity.class));
            return true;
        }
